...
class Thermometer(Instrument):
    ...
    def __init__(self, name: str, identifier: bytes, status=Status.AVAILABLE):
        super().__init__(name=name, connection_type=ConnectionType.HID, identifier=identifier, status=status)
